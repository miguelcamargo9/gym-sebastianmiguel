...
import com.gym.session.ObjetivoFacade;
...
public class ObjetivoController implements Serializable {
  ...
  @EJB
  private ObjetivoFacade ejbFacade;
  ...
  public Objetivo getSelected() {
    if (current == null) {
      current = new Objetivo();
      selectedItemIndex = -1;
    }
    return current;
  }

  private ObjetivoFacade getFacade() {
    return ejbFacade;
  }
  ...
  public String prepareView() {
    current = (Objetivo) getItems().getRowData();
  ...
  public String create() {
    try {
      ...
      JsfUtil.addSuccessMessage(ResourceBundle.getBundle("/Bundle").getString("ObjetivoCreated"));
  ...
  public String update() {
    try {
      ...
      JsfUtil.addSuccessMessage(ResourceBundle.getBundle("/Bundle").getString("ObjetivoUpdated"));
      return "View";
    } catch (Exception e) {
      JsfUtil.addErrorMessage(e, ResourceBundle.getBundle("/Bundle").getString("PersistenceErrorOccured"));
      return null;
  ...
  private void performDestroy() {
    try {
      ...
      JsfUtil.addSuccessMessage(ResourceBundle.getBundle("/Bundle").getString("ObjetivoDeleted"));
    } catch (Exception e) {
      JsfUtil.addErrorMessage(e, ResourceBundle.getBundle("/Bundle").getString("PersistenceErrorOccured"));
    }
  }
