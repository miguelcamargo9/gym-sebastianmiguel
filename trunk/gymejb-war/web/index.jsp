<%-- 
    Document   : index
    Created on : 14/09/2013, 06:26:05 PM
...
<html xmlns="http://www.w3.org/1999/xhtml">
  ...
  <body>
    <form id="login" action="LoginServlet" method="post">
      ...
      <fieldset id="inputs">
        <input name="idUsuario" type="text" onblur="if(this.value=='')this.value='INGRESE SU CEDULA';" onfocus="if(this.value=='INGRESE SU CEDULA')this.value='';" value="INGRESE SU CEDULA" />
        <input name="contrasena" type="text" onblur="if(this.value=='')this.value='INGRESE SU CONTRASEÑA';" onfocus="if(this.value=='INGRESE SU CONTRASEÑA')this.value='';" value="INGRESE SU CONTRASEÑA" />
      </fieldset>
      <fieldset id="actions">
        <input type="submit" id="submit" value="INGRESAR"/>
        <p class="option">desarrollado por: <br>Sebastian Rojas, Miguel Camargo &nbsp;&nbsp;</p>
      </fieldset>
    </form>
  </body>
</html>
